...
/**
 * @ClassName DwdTradeOrderPaySucDetailApp
 * @Package com.atguig.gmall.realtime.dwd.db.app
 * @Author CaiBW
 * @Create 24/01/31 上午 11:45
 * @Description 交易域支付成功事务事实表
 */
public class DwdTradeOrderPaySucDetailApp extends BaseSQLApp {
    public static void main(String[] args) {
        new DwdTradeOrderPaySucDetailApp().start(10016, 4, "dwd_trade_order_pay_suc_detail_app");
    }
    
    @Override
    public void handle(StreamTableEnvironment tableEnv, StreamExecutionEnvironment env, String groupId) {
        //TODO 1. 读取ods topic_db数据
        ...
        //  order_detail  interval join  payment_info
        // payment_info lookup join base_dic
